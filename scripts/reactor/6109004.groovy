...
Reactor6109004 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor6109004(rm: rm))
   return (Reactor6109004) getBinding().getVariable("reactor")
}
