...
public class GiveForeignDebuff implements PacketInput {
   ...
   public GiveForeignDebuff(int characterId, List<Pair<MapleDisease, Integer>> statups, MobSkill mobSkill) {
