...
class MagicAttack(private var _characterId: Int, private var _skill: Int, private var _skillLevel: Int,
                  ...
                  private var _charge: Int, private var _speed: Int, private var _direction: Int,
                  private var _display: Int) extends PacketInput {
  ...
  override def opcode(): SendOpcode = SendOpcode.MAGIC_ATTACK
}