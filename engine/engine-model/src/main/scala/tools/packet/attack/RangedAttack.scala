...
class RangedAttack(private var _characterId: Int, private var _skill: Int, private var _skillLevel: Int,
                   private var _stance: Int, private var _numAttackedAndDamage: Int, private var _projectile: Int,
  ...
  def projectile: Int = _projectile
  ...
  override def opcode(): SendOpcode = SendOpcode.RANGED_ATTACK
}