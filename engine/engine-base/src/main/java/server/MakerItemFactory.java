   ...
   private static double getMakerStimulantFee(int itemId) {
      if (YamlConfig.config.server.USE_MAKER_FEE_HEURISTICS) {
         ...
         return switch (et) {
            ...
            case LONG_COAT -> 2117.469118 * Math.exp(0.03355349137 * eqpLevel);
            ...
            default -> 4313.581428 * Math.exp(0.03147837094 * eqpLevel); // weapons
         };
      } else {
         return 14000;
      }
   ...
   private static double getMakerReagentFee(int itemId, int reagentLevel) {
      if (YamlConfig.config.server.USE_MAKER_FEE_HEURISTICS) {
         ...
         return switch (et) {
            ...
            case LONG_COAT -> 3405.23441 * Math.exp(0.03413001038 * eqpLevel) * reagentLevel;
            ...
            default -> 4538.650247 * Math.exp(0.0371980303 * eqpLevel) * reagentLevel; // weapons
         };
      } else {
