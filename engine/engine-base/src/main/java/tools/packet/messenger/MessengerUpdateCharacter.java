...
public class MessengerUpdateCharacter implements PacketInput {
   ...
   public MessengerUpdateCharacter(String characterNameFrom, MapleCharacter character, int position, int channel) {
