...
import net.server.channel.handlers.CancelAbnormalStatusHandler;
...
import net.server.channel.handlers.TeleportRockAddMapHandler;
...
import net.server.channel.handlers.UseGachaponExpHandler;
...
public class HandlerFactory {
   ...
   private void registerLoginHandlers(PacketProcessor packetProcessor) {
      ...
      packetProcessor.registerHandler(RecvOpcode.SERVER_LIST_REREQUEST, new ServerListRequestHandler());
      packetProcessor.registerHandler(RecvOpcode.CHARACTER_LIST_REQUEST, new CharacterListRequestHandler());
      ...
      packetProcessor.registerHandler(RecvOpcode.SERVER_LIST_REQUEST, new ServerListRequestHandler());
      packetProcessor.registerHandler(RecvOpcode.SERVER_STATUS_REQUEST, new ServerStatusRequestHandler());
   ...
   private void registerChannelHandlers(PacketProcessor packetProcessor) {
      ...
      packetProcessor.registerHandler(RecvOpcode.PLAYER_LOGGED_IN, new PlayerLoggedInHandler());
      ...
      packetProcessor.registerHandler(RecvOpcode.ENTER_CASH_SHOP, new EnterCashShopHandler());
      packetProcessor.registerHandler(RecvOpcode.DAMAGE_SUMMON, new DamageSummonHandler());
      packetProcessor.registerHandler(RecvOpcode.BUDDY_LIST_MODIFY, new BuddyListModifyHandler());
      packetProcessor.registerHandler(RecvOpcode.USE_ITEM_EFFECT, new UseItemEffectHandler());
      ...
      packetProcessor.registerHandler(RecvOpcode.CASH_SHOP_OPERATION, new CashOperationHandler());
      ...
      packetProcessor.registerHandler(RecvOpcode.CANCEL_ABNORMAL_STATUS, new CancelAbnormalStatusHandler());
      ...
      packetProcessor.registerHandler(RecvOpcode.TELEPORT_ROCK_ADD_MAP, new TeleportRockAddMapHandler());
      ...
      packetProcessor.registerHandler(RecvOpcode.USE_GACHAPON_EXP, new UseGachaponExpHandler());
      packetProcessor.registerHandler(RecvOpcode.NEW_YEAR_CARD_REQUEST, new NewYearCardHandler());
      packetProcessor.registerHandler(RecvOpcode.CASH_SHOP_SURPRISE, new CashShopSurpriseHandler());
      ...
      packetProcessor.registerHandler(RecvOpcode.USE_DEATH_ITEM, new UseDeathItemHandler());
      packetProcessor.registerHandler(RecvOpcode.PLAYER_MAP_TRANSFER, new PlayerMapTransitionHandler());
      packetProcessor.registerHandler(RecvOpcode.USE_MAPLE_LIFE, new UseMapleLifeHandler());
      ...
      packetProcessor.registerHandler(RecvOpcode.LEFT_KNOCK_BACK, new LeftKnockBackHandler());
      ...
      packetProcessor.registerHandler(RecvOpcode.OPEN_ITEM_UI, new RaiseUIStateHandler());
      packetProcessor.registerHandler(RecvOpcode.USE_ITEM_UI, new RaiseIncExpHandler());
      ...
      packetProcessor.registerHandler(RecvOpcode.CHANGE_QUICK_SLOT, new ChangeQuickSlotHandler());
   }
}
