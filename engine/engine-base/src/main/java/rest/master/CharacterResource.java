...
import rest.master.attributes.CanHoldAllAttributes;
import rest.master.attributes.CanHoldAttributes;
import rest.master.attributes.CanHoldItem;
import rest.master.attributes.CharacterAttributes;
import rest.master.attributes.CharacterItemAttributes;
import rest.master.attributes.CharacterSkillAttributes;
import rest.master.attributes.CheckSpaceAttributes;
import rest.master.attributes.CheckSpaceResponseAttributes;
import rest.master.attributes.FreeSlotAttributes;
import rest.master.attributes.MessageAttributes;
import rest.master.attributes.MonsterBookAttributes;
import rest.master.attributes.NpcAttributes;
import rest.master.attributes.PetAttributes;
import rest.master.attributes.QuestCompletionAttributes;
import rest.master.attributes.QuestFinishAttributes;
import rest.master.attributes.QuestTimeLimitAttributes;
import rest.master.attributes.QuestUpdateAttributes;
import rest.master.attributes.builders.CharacterAttributesBuilder;
import rest.master.attributes.builders.CharacterItemAttributesBuilder;
import rest.master.attributes.builders.CharacterSkillAttributesBuilder;
import rest.master.attributes.builders.CheckSpaceResponseAttributesBuilder;
import rest.master.attributes.builders.FreeSlotAttributesBuilder;
import rest.master.attributes.builders.MonsterBookAttributesBuilder;
import rest.master.attributes.builders.NpcAttributesBuilder;
import rest.master.attributes.builders.PetAttributesBuilder;
