...
class StoreInStorage(private var _slots: Byte, private var _inventoryType: MapleInventoryType, private var _items: java.util.Collection[Item]) extends PacketInput {
