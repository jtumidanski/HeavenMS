...
public enum SendOpcode {
   ...
   SERVER_STATUS(0x03),//CHECK_USER_LIMIT_RESULT
   ...
   HACK_SHIELD_REQUEST(0x15),//maybe this is RELOG_RESPONSE, can't care less
   RELOG_RESPONSE(0x16),
   ...
   FIELD_EFFECT(0x8A),
   FIELD_OBSTACLE_ON_OFF(0x8B),
   FIELD_OBSTACLE_ON_OFF_LIST(0x8C),
   ...
   ADMIN_RESULT(0x90),
   OX_QUIZ(0x91),//QUIZ
   GM_EVENT_INSTRUCTIONS(0x92),//DESC
   CLOCK(0x93),
   CONTI_MOVE(0x94),
   CONTI_STATE(0x95),
   ...
   DROP_ITEM_FROM_MAP_OBJECT(0x10C),
   ...
   MTS_OPERATION(0x15C),
   MAPLE_LIFE_RESULT(0x15D),
   MAPLE_LIFE_ERROR(0x15E),
