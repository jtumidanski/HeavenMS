   ...
   def end(Byte mode, Byte type, Integer selection) {
      ...
      if (status == 0) {
         ...
         if (mode == 0) {
            ...
            qm.sendNext("Okay, okay. Welcome to the Resistance, kid. From now on, you will play the role of a Battle Magician, a fierce Magician always ready to lead your party into battle.")
         }
      } else if (status == 2) {
