...
class Quest21000 {
   ...
   def start(Byte mode, Byte type, Integer selection) {
      ...
      if (status == 0) {
         ...
         qm.forceStartQuest()
         qm.sendNext("#bThe child is probably lost deep inside the forest!#k We have to escape before the Black Magician finds us. You must rush into the forest and bring the child back with you!")
      } else if (status == 2) {
         qm.sendNextPrev("Don't panic, Aran. If you wish to check the status of the \r\nquest, press #bQ#k and view the Quest window.")
      } else if (status == 3) {
         qm.sendNextPrev("Please, Aran! I'm begging you. I can't bear to lose another person to the Black Magician!")
      } else if (status == 4) {
