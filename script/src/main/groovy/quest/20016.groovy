...
class Quest20016 {
   ...
   def start(Byte mode, Byte type, Integer selection) {
      ...
      if (status == 0) {
         ...
         qm.sendNextPrev("But that's not the case right now. We've been finding signs all over Maple World that foreshadow the revival of the Black Magician. We can't have the Black Mage come back to terrorize Maple World as he has in the past!")
      } else if (status == 5) {
         ...
         qm.sendNextPrev("This is why the young Empress has decided to take matters into her own hands. She's forming a knighthood of brave Maplers to defeat the Black Magician once and for all. You know what you need to do, right? I'm sure you have an idea since you, yourself, signed up to be a Knight.")
      } else if (status == 7) {
         qm.sendNextPrev("We have to get stronger so we can defeat the Black Magician if he revives. Our primary goal is to prevent him from destroying Maple World, and you will play a prominent role in that.")
      } else if (status == 8) {
         ...
         qm.sendNext("I'm glad you're clear about our current situation, but you know, at your current level, you're not even strong enough to face the Black Magician's minions, let alone the Black Mage himself. Not even his minions' minions, as a matter of fact. How will you protect Maple World at your current level?")
      } else if (status == 10) {
