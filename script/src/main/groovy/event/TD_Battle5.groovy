...
class EventTD_Battle5 {
   EventManager em
   boolean isPq = true
   int minPlayers = 2, maxPlayers = 6
   int minLevel = 70, maxLevel = 255
   int entryMap = 240070603
   int exitMap = 240070602
   int recruitMap = 240070602
   int clearMap = 240070602
   int minMapId = 240070603
   int maxMapId = 240070603
   int eventTime = 20
   int[] lobbyRange = [0, 0]

   int tdBossId = 8220015
...
EventTD_Battle5 getEvent() {
   if (!getBinding().hasVariable("event")) {
      EventManager em = (EventManager) getBinding().getVariable("em")
      getBinding().setVariable("event", new EventTD_Battle5(em: em))
   }
   return (EventTD_Battle5) getBinding().getVariable("event")
}
