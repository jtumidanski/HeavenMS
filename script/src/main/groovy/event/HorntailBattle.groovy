...
class EventHorntailBattle {
   ...
   def setup(int channel) {
      ...
      MapleLifeFactory.getMonster(8810000).ifPresent({ mob -> map.spawnMonsterOnGroundBelow(mob, new Point(960, 120)) })

      map = eim.getInstanceMap(240060100)
      MapleLifeFactory.getMonster(8810001).ifPresent({ mob -> map.spawnMonsterOnGroundBelow(mob, new Point(-420, 120)) })
