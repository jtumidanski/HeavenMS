...
class EventTD_Battle4 {
   EventManager em
   boolean isPq = true
   int minPlayers = 2, maxPlayers = 6
   int minLevel = 70, maxLevel = 255
   int entryMap = 240070503
   int exitMap = 240070502
   int recruitMap = 240070502
   int clearMap = 240070502
   int minMapId = 240070503
   int maxMapId = 240070503
   int eventTime = 15
   int[] lobbyRange = [0, 0]

   int tdBossId = 8220012
...
EventTD_Battle4 getEvent() {
   if (!getBinding().hasVariable("event")) {
      EventManager em = (EventManager) getBinding().getVariable("em")
      getBinding().setVariable("event", new EventTD_Battle4(em: em))
   }
   return (EventTD_Battle4) getBinding().getVariable("event")
}
