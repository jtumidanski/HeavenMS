...
class NPC9120201 {
   ...
   EventManager em
   MapleExpeditionType exped = MapleExpeditionType.SHOWA
   String expedName = "Showa Gang"
   String expedBoss = "The Boss"
   String expedMap = "Nightmarish Last Days"
   int expedItem = 4000138
