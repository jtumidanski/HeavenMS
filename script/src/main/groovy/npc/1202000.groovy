         ...
         if (cm.getPlayer().getMapId() == 140090000) {
            if (!cm.containsAreaInfo((short) 21019, "helper=clear")) {
               if (status == 0) {
                  ...
                  cm.sendNextPrev("The hero who fought against the Black Mage... I've been waiting for you to wake up!", (byte) 8)
               } else if (status == 3) {
               ...
               if (status == 0) {
                  ...
                  cm.sendNextPrev("Stay calm. There is no need to panic. You can't remember anything because the curse of the Black Mage erased your memory. I'll tell you everything you need to know...step by step.", (byte) 8)
               } else if (status == 3) {
                  cm.sendNextPrev("You're a hero who fought the Black Mage and saved Maple World hundreds of years ago. But at the very last moment, the curse of the Black Mage put you to sleep for a long, long time. That's when you lost all of your memories.", (byte) 8)
               } else if (status == 4) {
                  cm.sendNextPrev("This island is called Rien, and it's where the Black Mage trapped you. Despite its name, this island is always covered in ice and snow because of the Black Mage's curse. You were found deep inside the Ice Cave.", (byte) 8)
               } else if (status == 5) {
