...
class NPC9270047 {
   ...
   EventManager em
   MapleExpeditionType exped = MapleExpeditionType.SCARGA
   String expedName = "Scarga"
   String expedBoss = "Scarlion and Targa"
   String expedMap = "Spooky World"
   int expedItem = 4032246
