...
class Reactor2001011 extends SimpleReactor {
   def act() {
...
Reactor2001011 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor2001011(rm: rm))
   return (Reactor2001011) getBinding().getVariable("reactor")
}
