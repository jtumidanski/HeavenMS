...
class Reactor2001015 extends SimpleReactor {
   def act() {
...
Reactor2001015 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor2001015(rm: rm))
   return (Reactor2001015) getBinding().getVariable("reactor")
}
