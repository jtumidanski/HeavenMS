...
class Reactor6109005 extends SimpleReactor {
   def act() {
...
Reactor6109005 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor6109005(rm: rm))
   return (Reactor6109005) getBinding().getVariable("reactor")
}
