...
class Reactor2001004 extends SimpleReactor {
   def act() {
...
Reactor2001004 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor2001004(rm: rm))
   return (Reactor2001004) getBinding().getVariable("reactor")
}
