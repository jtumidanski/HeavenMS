...
class Reactor2001012 extends SimpleReactor {
   def act() {
...
Reactor2001012 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor2001012(rm: rm))
   return (Reactor2001012) getBinding().getVariable("reactor")
}
