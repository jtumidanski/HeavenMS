...
class Reactor2001003 extends SimpleReactor {
   def act() {
...
Reactor2001003 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor2001003(rm: rm))
   return (Reactor2001003) getBinding().getVariable("reactor")
}
