...
class Reactor9108005 extends SimpleReactor {
   def act() {
...
Reactor9108005 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor9108005(rm: rm))
   return (Reactor9108005) getBinding().getVariable("reactor")
}
