...
class Reactor6109001 extends SimpleReactor {
   def act() {
      ...
      if (eim != null) {
         ...
         if (mapId == 610030200) {
            MessageBroadcaster.getInstance().sendServerNotice(eim.getPlayers(), ServerNoticeType.LIGHT_BLUE, I18nMessage.from("ARCHER_SIGIL_ACTIVATED"))
            ...
            MessageBroadcaster.getInstance().sendServerNotice(eim.getPlayers(), ServerNoticeType.LIGHT_BLUE, I18nMessage.from("ARCHER_SIGIL_ACTIVATED_LONG"))
