...
class Reactor9108001 extends SimpleReactor {
   def act() {
...
Reactor9108001 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor9108001(rm: rm))
   return (Reactor9108001) getBinding().getVariable("reactor")
}
