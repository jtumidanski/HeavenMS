...
class Reactor2001013 extends SimpleReactor {
   def act() {
...
Reactor2001013 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor2001013(rm: rm))
   return (Reactor2001013) getBinding().getVariable("reactor")
}
