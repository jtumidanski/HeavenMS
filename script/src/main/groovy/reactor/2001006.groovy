...
class Reactor2001006 extends SimpleReactor {
   def act() {
...
Reactor2001006 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor2001006(rm: rm))
   return (Reactor2001006) getBinding().getVariable("reactor")
}
