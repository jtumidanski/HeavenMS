...
class Reactor6109006 extends SimpleReactor {
   def act() {
...
Reactor6109006 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor6109006(rm: rm))
   return (Reactor6109006) getBinding().getVariable("reactor")
}
