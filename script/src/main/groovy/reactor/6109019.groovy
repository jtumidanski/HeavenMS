...
class Reactor6109019 extends SimpleReactor {
   def act() {
...
Reactor6109019 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor6109019(rm: rm))
   return (Reactor6109019) getBinding().getVariable("reactor")
}
