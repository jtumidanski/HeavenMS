...
class Reactor9108004 extends SimpleReactor {
   def act() {
...
Reactor9108004 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor9108004(rm: rm))
   return (Reactor9108004) getBinding().getVariable("reactor")
}
