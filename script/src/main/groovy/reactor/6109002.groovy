...
class Reactor6109002 extends SimpleReactor {
   def act() {
      ...
      if (eim != null) {
         ...
         if (mapId == 610030200) {
            MessageBroadcaster.getInstance().sendServerNotice(eim.getPlayers(), ServerNoticeType.LIGHT_BLUE, I18nMessage.from("MAGICIAN_SIGIL_ACTIVATED"))
            ...
            MessageBroadcaster.getInstance().sendServerNotice(eim.getPlayers(), ServerNoticeType.LIGHT_BLUE, I18nMessage.from("MAGICIAN_SIGIL_ACTIVATED_LONG"))
