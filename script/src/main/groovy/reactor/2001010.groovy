...
class Reactor2001010 extends SimpleReactor {
   def act() {
...
Reactor2001010 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor2001010(rm: rm))
   return (Reactor2001010) getBinding().getVariable("reactor")
}
