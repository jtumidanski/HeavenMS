...
class Reactor2001014 extends SimpleReactor {
   def act() {
...
Reactor2001014 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor2001014(rm: rm))
   return (Reactor2001014) getBinding().getVariable("reactor")
}
