...
class Reactor2001008 extends SimpleReactor {
   def act() {
...
Reactor2001008 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor2001008(rm: rm))
   return (Reactor2001008) getBinding().getVariable("reactor")
}
