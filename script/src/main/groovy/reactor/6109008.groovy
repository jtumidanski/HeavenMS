...
class Reactor6109008 extends SimpleReactor {
   def act() {
...
Reactor6109008 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor6109008(rm: rm))
   return (Reactor6109008) getBinding().getVariable("reactor")
}
