...
class Reactor2001005 extends SimpleReactor {
   def act() {
...
Reactor2001005 getReactor() {
   ReactorActionManager rm = (ReactorActionManager) getBinding().getVariable("rm")
   getBinding().setVariable("reactor", new Reactor2001005(rm: rm))
   return (Reactor2001005) getBinding().getVariable("reactor")
}
