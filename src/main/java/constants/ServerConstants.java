...
public class ServerConstants {
   ...
   public static final boolean USE_STARTING_AP_4 = true;
   ...
   public static final double EQUIP_EXP_RATE = 0.0;                //Rate for equipment exp gain, grows linearly. Set 1.0 for default (about 100~200 same-level range mobs killed to pass equip from level 1 to 2).
   ...
   public static final int FAMILY_MAX_GENERATIONS = 1000;
   ...
   public static long TIMEOUT_DURATION = 3600000L;
   //Event End Timestamp
